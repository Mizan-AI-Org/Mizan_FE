  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [insightsRes, tipsRes, tasksRes, schedulingRes] = await Promise.all([
        ...
        fetch(`${API_BASE}/assistant/scheduling_recommendations/`, { headers })
      ]);
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Get intelligent insights and recommendations for your restaurant</p>
      </div>
        ...
        <TabsContent value="chat">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ask any question about your restaurant</CardDescription>
            </CardHeader>
                ...
                <Card key={idx} className={`border-l-4 ${
                  ...
                  <CardContent className="pt-6">
                    <div className="flex gap-4">
                      {insight.type === 'SUCCESS' && <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0" />}
                      {insight.type === 'WARNING' && <AlertCircle className="w-6 h-6 text-yellow-500 flex-shrink-0" />}
                      {insight.type === 'INFO' && <Lightbulb className="w-6 h-6 text-blue-500 flex-shrink-0" />}
                ...
                <Card key={idx}>
                  <CardContent className="pt-6">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-lg mb-2">{tip.area}</h3>
                        <p className="text-gray-700 mb-3">{tip.tip}</p>
                        
                        <div className="grid grid-cols-2 gap-2">
                          <div className="bg-green-50 p-3 rounded">
                            <p className="text-xs text-gray-600">Potential Savings</p>
                            <p className="font-bold text-green-600">{tip.potential_savings}</p>
                          </div>
                          <div className="bg-blue-50 p-3 rounded">
                            <p className="text-xs text-gray-600">Difficulty</p>
                            <p className="font-bold text-blue-600">{tip.difficulty}</p>
                          </div>
                        </div>
                      </div>
                    </div>
