...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      aria-label={i18n.t("common.dialog")}
      className={cn(
      ...
      {...props}
    >
      {/* Fallback description for accessibility when none is provided */}
      <DialogPrimitive.Description className="sr-only">{i18n.t("common.dialog")}</DialogPrimitive.Description>
      {children}
