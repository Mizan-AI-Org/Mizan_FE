...
export default function OpsBackNav({
  ...
  return (
    <Link
      to={to}
      className="group inline-flex h-9 items-center gap-2 rounded-lg border border-slate-200 bg-card px-3 text-sm font-medium text-slate-700 shadow-sm transition-colors hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-800 dark:border-slate-600 dark:text-slate-200 dark:hover:border-emerald-700 dark:hover:bg-emerald-950/40 dark:hover:text-emerald-300"
    >
