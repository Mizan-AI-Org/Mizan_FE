...
export const AutoSchedule: React.FC = () => {
    ...
    const [scheduleResults, setScheduleResults] = useState<AutoScheduleResult | null>(null);
        ...
        <div className="space-y-6 p-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600 mt-2">
                        Automatically generate staff schedules based on templates and demand forecasts
                    </p>
                </div>
            </div>
            ...
            <Tabs defaultValue="scheduler" className="space-y-4">
                ...
                <TabsContent value="scheduler">
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            {showResults && scheduleResults && (
                                <Alert variant={scheduleResults.success ? "default" : "destructive"}>
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="font-semibold">{scheduleResults.message}</h3>
                                            {scheduleResults.shifts_created && (
                                                <p className="text-sm mt-1">{scheduleResults.shifts_created} shifts created</p>
                                            )}
                                            {scheduleResults.conflicts_detected && (
                                                <p className="text-sm mt-1">{scheduleResults.conflicts_detected} conflicts detected</p>
                                            )}
                                        </div>
                                    </div>
                                </Alert>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                        Choose a schedule template to use as the basis for auto-scheduling
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <Select value={demandLevel} onValueChange={setDemandLevel}>
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="MEDIUM">Medium (60% staffing)</SelectItem>
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="text-sm text-gray-600 mt-1">
                                        Set a maximum budget for labor costs (AI will optimize within this limit)
                                    </p>
                                </div>
                            </div>
                    ...
                    <Card className="mt-6">
                        <CardHeader>
                            <CardTitle className="text-lg">How Auto-Scheduling Works</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-3">
                            <div className="flex gap-3">
                                <div className="flex items-center justify-center h-8 w-8 rounded-full bg-blue-100 text-blue-600 font-semibold text-sm flex-shrink-0">1</div>
                                <div>
                                    <p className="font-semibold">Select Template</p>
                                    <p className="text-sm text-gray-600">Choose a template that defines typical shift patterns</p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <div className="flex items-center justify-center h-8 w-8 rounded-full bg-blue-100 text-blue-600 font-semibold text-sm flex-shrink-0">2</div>
                                <div>
                                    <p className="font-semibold">Set Parameters</p>
                                    <p className="text-sm text-gray-600">Configure demand levels and optional budget constraints</p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <div className="flex items-center justify-center h-8 w-8 rounded-full bg-blue-100 text-blue-600 font-semibold text-sm flex-shrink-0">3</div>
                                <div>
                                    <p className="font-semibold">AI Generates Schedule</p>
                                    <p className="text-sm text-gray-600">System creates optimal schedule considering staff availability and constraints</p>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <div className="flex items-center justify-center h-8 w-8 rounded-full bg-blue-100 text-blue-600 font-semibold text-sm flex-shrink-0">4</div>
                                <div>
                                    <p className="font-semibold">Review & Publish</p>
                                    <p className="text-sm text-gray-600">Review the generated schedule and publish to notify staff</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-gray-700">
                                    Auto-scheduling uses AI algorithms to automatically assign shifts to staff members based on templates, 
                                    availability, demand forecasts, and labor budget constraints. This saves time and ensures optimal 
                                    coverage of required positions.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
                                    <li>Create comprehensive templates with all required roles</li>
